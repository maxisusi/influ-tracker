...
const Avatar = ({ avatarName }) => {
    ...
    const { userName, fullName, locationShowName, picture } = avatarName;
    let interest = avatarName.audienceStatistics.audienceInterestsCategories;
                    ...
                    <div className={styles.avatarDatas}>
                        <div className={styles.avatarIGDatas}>
                            ...
                            <div className={styles.igName}>
                                <p>@{userName}</p>
                                <svg xmlns="http://www.w3.org/2000/svg" width="12.9" height="12.9" viewBox="0 0 11.101 11.01">
